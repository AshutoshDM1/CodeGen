...
import { Show } from '@/store/showTabStore';
...
const CodeEditor = () => {
  ...
  useEffect(() => {
    if (editor && monacoInstance) {
      ...
      if (model) {
        monacoInstance.editor.setModelLanguage(model, getLanguageFromPath(filePaths));
      }
    }
  }, [filePaths, editor, showTab, monacoInstance, getLanguageFromPath]);
  ...
  return (
    <>
      <ResizablePanel defaultSize={50} minSize={30} maxSize={70}>
        <AnimatePresence key="workspaceViewCodeEditorRoute" mode="wait" initial={true}>
          <motion.div
                                      ...
                                      <Input
                                        ...
                                        onKeyDown={(e) => {
                                          if (e.key === 'Enter' && newItemName.trim()) {
                                            renameFileExplorer(filePaths, newItemName.trim());
                                            setNewItemName('');
                          ...
                          loading={
                            <div className="h-full w-full flex items-center justify-center">
                              <div className="flex flex-col items-center gap-2">
                                ...
                                <p className="text-sm text-neutral-400">Initializing editor...</p>
                              </div>
                            </div>
                          }
