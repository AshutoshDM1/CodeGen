    ...
    <>
      <div className="h-[4vh] w-full flex justify-center items-center select-none mt-[1vh] relative z-[10]  ">
        <div className="h-full max-w-[43rem] mx-auto w-full flex justify-between items-center px-1 py-1  text-white rounded-[25px] backdrop-blur-sm ">
          ...
          <div className="font-[100] font-[monospace] letter- text-[15px] cursor-pointer hidden md:flex justify-evenly w-[45vh] ">
            <h1>Explore</h1>
            <h1>Features</h1>
            <h1>Github</h1>
          </div>
          <div className="h-full flex justify-center items-center ">
            <button
              onClick={onClick}
              disabled={isLoading}
              className="h-full w-32 font-[600] text-[15px] text-[#000] cursor-pointer bg-slate-50 px-[17px]  rounded-[30px] flex justify-center items-center gap-2"
            >
              {isLoading ? (
